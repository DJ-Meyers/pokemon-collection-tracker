...
type ButtonVariant = "default" | "danger" | "success" | "warning" | "purple";
...
const variantColors: Record<ButtonVariant, { primary: string; secondary: string; tertiary: string; selected: string }> = {
  default: {
    ...
    secondary: "border border-gray-300 bg-gray-50 text-gray-700 hover:bg-blue-600 hover:border-blue-600 hover:text-white hover:shadow-sm",
  ...
  danger: {
    ...
    secondary: "border border-red-300 bg-red-50 text-red-600 hover:bg-red-600 hover:border-red-600 hover:text-white hover:shadow-sm",
  ...
  success: {
    ...
    secondary: "border border-green-300 bg-green-50 text-green-600 hover:bg-green-600 hover:border-green-600 hover:text-white hover:shadow-sm",
  ...
  warning: {
    ...
    secondary: "border border-yellow-300 bg-yellow-50 text-yellow-600 hover:bg-yellow-500 hover:border-yellow-500 hover:text-white hover:shadow-sm",
  ...
  purple: {
    ...
    secondary: "border border-purple-300 bg-purple-50 text-purple-600 hover:bg-purple-600 hover:border-purple-600 hover:text-white hover:shadow-sm",
    tertiary: "text-purple-600 border border-transparent hover:border-purple-200 hover:bg-purple-50",
